...
[자바스크립트 X ES -2 > 비구조화 할당](https://taeny.dev/javascript/11%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8xes2/#3-%EB%B9%84%EA%B5%AC%EC%A1%B0%ED%99%94%ED%95%A0%EB%8B%B9)
...
기존의 DOM element를 불러와 해당 컴포넌트(`<App/>`)를 렌더링한다.
