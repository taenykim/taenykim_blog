...
부스트캠프에서의 학습은 스스로 진행되었다. 학교수업처럼 어떤 개념에 대해서 강의를 하는 것이 아니라, 미션을 주고 그 개념을 스스로 학습한 후 수행해야했다.

개발이라는 것은 언제 어떤 문제들이 일어날 지 모르고, 문제를 해결하는 방법이 시험지처럼 정답이 정해진 것도 아니다. 그렇기 때문에 문제에 대해서 알든, 모르든 어떻게 해결할 것인가에 대해서 고민하고 해결해나가는 방법을 스스로 배우는 것이 부스트캠프에서 추구하는 것이 아닐까 생각해보았다.

개발자는 끊임없이 탐구하고 공부해야한다는 이야기를 많이 한다. 그렇기에 중요한 것은 `현재 무엇을 아느냐` 보다는 `앞으로 모르는 것이 나와도 잘 해결할 수 있느냐` 가 아닐까?

앞으로 미션을 해결하는 것 자체보다는 내가 미션을 어떻게 해결하는지, 해결하는 과정 속에서 무엇을 배우고 있는지에 좀 더 집중해야 겠다.
...
중요한 것은 `내가 이렇게 멋있는 코드를 짤 수 있어!`하고 나만의 코딩스타일을 정해버리는 것 보다는 `이렇게 짠 코드는 이런특징이 있어!` 하고 여러 코딩스타일에 대해서 특징을 잘 캐치할 수 있는 능력이 아닐까 생각해보았다. 많은 사람들의 다양한 코드를 보면서 **"이 사람은 왜 이렇게 짰을까?"** 하는 고민을 많이 해봐야겠다.

그리고 **"불특정다수가 이해하기 쉽게 작성되어야하는 오픈소스는 그렇기 때문에 이런 고민들이 많이 녹아들어가 있지는 않을까?"** 생각도 해보았는데, 여유가 생기면 내가 관심있는 분야의 오픈소스도 뜯어보면서 공부해야겠다고 생각했다.
...
하지만 마스터분들께서는 전문적으로 깊게 파본 경험은 다른 분야를 하게되더라도 큰 도움이 될거고 그것이 자기의 장점이 될 수도 있을 거라고 말씀해주셨다. 올바른 학습방향과 많은 노력이 더 중요하겠지만, 우선 지금은 `지속가능한 개발 역량`을 쌓는 것에 더 집중해야겠다.
...
그렇기 때문에 모르는 문제나 어려운 문제에 부딪혔을 때, 해결할 수 있다는 `의지와 자신감`과 어려운문제을 대처하는 `나만의 태도와 방법` 같은 것들을 이번 부스트캠프에서 많이 배워가고 싶다.
